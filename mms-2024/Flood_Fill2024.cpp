...
int autoRun(int x, int y, int D) {
    ...
    if(floodFill_coordinate[x][y] == 0) return D+4; //Nếu đến đích thì trả về một số ngoài khoảng (0-3) + 4 để có thể -4 để lấy được hướng hiện tại
