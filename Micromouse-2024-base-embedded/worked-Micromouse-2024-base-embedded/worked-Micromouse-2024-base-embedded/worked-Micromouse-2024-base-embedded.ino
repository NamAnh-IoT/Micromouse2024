...
void setup() {
  ...
  pinMode(IRT3,OUTPUT);
  pinMode(IRT4,OUTPUT);
  // analogWrite(IRT1, 124); //trên trái
  // analogWrite(IRT2, 141); //phải
  // analogWrite(IRT3, 88); //trái
  // analogWrite(IRT4, 114); //trên phải

  // analogWrite(IRT1, 100); //trên trái
  // analogWrite(IRT2, 100); //phải
  // analogWrite(IRT3, 100); //trái
  // analogWrite(IRT4, 100); //trên phải
  ...
  // while(!reach_goal) {
  //   wall(x,y);
  //   Serial.println(F("wall oke"));
  //   //log("wall ok");
  //   //show_wall(x,y);
  //   //log("show_wall ok");
  //   Flood_Fill();
  //   Serial.println(F("oke 1"));
  //   //log("Flood_Fill ok");
  //   //log((floodfill[x][y]));
  //   Move();
  //   Serial.println(F("oke 2"));
  //   //log("move ok");
  //   Oxy();
  //   Serial.println(F("oke 3"));
  //   //log("Oxy ok");
  //   goal_detemine();
  //   Serial.println(F("oke 4"));

  //   Serial.print(F("wallLeft:"));
  //   Serial.print(wallLeft());
  //   Serial.print(F(","));
  //   Serial.print(F("wallFront:"));
  //   Serial.print(wallFront());
  //   Serial.print(F(","));
  //   Serial.print(F("wallRight:"));
  //   Serial.println(wallRight());
  // }
  // Flood_Fill();

  //Chạy xong thì nháy xanh lục chờ bấm nút
  while(digitalRead(usrButton) == 1) {
    // targetIrLeft = analogRead(IRR1);
    // targetIrRight = analogRead(IRR4);
